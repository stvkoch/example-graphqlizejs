...
/**
Additional resolver merged with the resolvers generated by graphqlizejs
*/
const login = sequelize => async (root, args) => {
  ...
  // silly password comparation, you can use instance method of credential model to
  // delegate the comparation for example
...
// resolvers generate by graphqlizejs, with subscription and additional resolvers
